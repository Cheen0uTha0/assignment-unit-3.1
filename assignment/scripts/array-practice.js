...
let favoriteFoods = ['pho', 'instant noodle', 'tum yum', 'pizza', 'steak'];
...
console.log('Add to the beginning of favorite food', favoriteFoods);
...
colors.pop();
console.log('Stored last color', lastColor);
